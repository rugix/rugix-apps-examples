...
The examples use open-source components only. This matrix is for example
selection and packaging due diligence; it is not legal advice.
...
| FastAPI | Historian HTTP API | MIT |
| Uvicorn | Historian HTTP server | BSD-3-Clause |
